...
public class KeyService {
    ...
    public void generateAndStoreKey() throws NoSuchAlgorithmException {
        ...
        try (FileOutputStream fos = new FileOutputStream(fullPath)) {
            fos.write(Base64.encodeBase64(secretKey.getEncoded()));
        } catch (Exception e) {
            throw new RuntimeException("Erro ao armazenar a chave", e);
        }
